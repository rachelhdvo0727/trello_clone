...
function showTasks(task) {
  ...
  clone.querySelector(".deadline").textContent = "Due: " + moment(task.deadline).format("DD/MM/YYYY HH.MM");
  clone.querySelector(".priority").textContent = task.priority;
  clone.querySelector(".creator").textContent = "By: " + task.creator;
  clone.querySelector(".date_added").textContent = moment(task.date_added).fromNow();
...
function putNewData(data, id) {
  ...
  fetch("".concat(_vars.dataTrello, "/").concat(id), {
    ...
    copy.querySelector(".deadline").textContent = "Due: " + moment(data.deadline).format("DD/MM/YYYY HH.MM");
    copy.querySelector(".priority").textContent = data.priority;
    copy.querySelector(".creator").textContent = "Created by: " + data.creator;
    copy.querySelector(".date_added").textContent = moment(data.date_added).fromNow();
