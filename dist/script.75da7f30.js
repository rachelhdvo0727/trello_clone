...
},{}],"jsmodules/vars.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.validForm = exports.cards = exports.errormsgs = exports.formElms = exports.elements = exports.displayList = exports.form = exports.addNewBtn = exports.dataTrello = exports.apiKey = void 0;
...
var _vars = require("./jsmodules/vars");
...
function showTasks(task) {
  ...
  clone.querySelector(".deadline").textContent = "Due: " + (0, _moment.default)(task.deadline).format("DD/MM/YYYY HH.MM");
  clone.querySelector(".priority").textContent = task.priority;
  clone.querySelector(".creator").textContent = "By: " + task.creator;
  clone.querySelector(".date_added").textContent = (0, _moment.default)(task.date_added).fromNow();
  clone.querySelector("button.close").addEventListener("click", function () {
    deleteATask(task._id);
  });
  clone.querySelector("button.editbtn").addEventListener("click", function () {
